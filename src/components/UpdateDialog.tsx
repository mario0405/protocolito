        ...
        <DialogHeader>
          ...
          <DialogDescription>
            {isDownloading
              ...
              : t('update.newVersionAvailable').replace('{version}', String(updateInfo.version))}
          </DialogDescription>
        </DialogHeader>
            ...
            <div className="space-y-2">
              <div className="relative">
                ...
                <div className="flex justify-between text-xs text-gray-600 mt-1">
                  <span>{t('update.percentComplete').replace('{percent}', String(Math.round(progress.percentage)))}</span>
                  {progress.total > 0 && (
                    <span>
