...
const HOMEBREW_PATHS = [
  '/opt/homebrew/var/protocolito/meeting_minutes.db',
  '/usr/local/var/protocolito/meeting_minutes.db',
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-sm font-semibold text-blue-900">
              Previous Meeting App Installation Detected
            </h3>
          </div>
          <p className="text-sm text-blue-800 mb-2">
            We found an existing database from a previous Meetily installation (Python backend version).
          </p>
