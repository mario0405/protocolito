  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        {/* Recording controls - only show after recording starts and not while status overlays are active */}
        {recordingState.isRecording &&
          status !== RecordingStatus.PROCESSING_TRANSCRIPTS &&
          status !== RecordingStatus.SAVING && (
            <div className="fixed bottom-8 left-0 right-0 z-10">
              ...
              >
                <div className="rounded-full border border-stone-200 bg-white/95 p-2 shadow-xl backdrop-blur">
